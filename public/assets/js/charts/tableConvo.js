...
function tableFacebook(chartId,chartData) {
    var theTable = $('#'+chartId+'Table').DataTable( {
        ...
        columns: [
            ...
            {
                "data": "Comments", "title": "<span class='fa fa- fa-comment' title='Comment' uk-tooltip></span>", "class": "uk-text-right", "width": "2.5%"
            },
            {
                "data": "Likes", "title": "<span class='fa fa- fa-thumbs-up' title='Like' uk-tooltip></span>", "class": "uk-text-right", "width": "2.5%"
            },
            {
                "data": "Shares", "title": "<span class='fa fa- fa-share' title='Share' uk-tooltip></span>", "class": "uk-text-right", "width": "2.5%"
            },
			{
...
function tableTwitter(chartId,chartData) {
    var theTable = $('#'+chartId+'Table').DataTable( {
        ...
        columns: [
            ...
            {
                "data": "Interactions", "title": "Inter- actions", "class": "uk-text-right", "width": "5%"
            },
            {
                "data": "Original Reach", "title": "Original Reach", "class": "uk-text-right", "width": "5%"
            },
            {
                "data": "Viral Reach", "title": "Viral Reach", "class": "uk-text-right", "width": "5%"
            },
            {
                "data": "Viral Score", "title": "Viral Score", "class": "uk-text-right", "width": "5%"
            },
            {
                "title": "","width": "10%","orderable": false,"class": "sentiment uk-text-center",
                "data": "sentiment",
				"createdCell": function (td, cellData, rowData, row, col) {
					var id = rowData['id'];
					console.log(id);
...
function tableNews(chartId,chartData) {
    var theTable = $('#'+chartId+'Table').DataTable( {
        ...
        columns: [
            ...
            { "data": "Media", "title": "Media", "width": "20%" },
			{
                "title": "Post", "width": "30%",
                "data": function ( data ) {
            ...
            {
                "data": "Comments", "title": "Comments", "class": "uk-text-right", "width": "7.5%"
            },
            {
                "data": "Reach", "title": "Reach", "class": "uk-text-right", "width": "7.5%"
            },
            {
                "title": "","width": "10%","orderable": false,"class": "sentiment uk-text-center",
                "data": "sentiment",
...
function tableVideo(chartId,chartData) {
    var theTable = $('#'+chartId+'Table').DataTable( {
        ...
        columns: [
            ...
            {
                "data": "view", "title": "View", "class": "uk-text-right", "width": "7.5%"
            },
            {
                "title": "","width": "10%","orderable": false,"class": "sentiment uk-text-center",
                "data": "Sentiment",
...
function tableInstagram(chartId,chartData) {
    var theTable = $('#'+chartId+'Table').DataTable( {
        ...
        columns: [
            ...
            {
                "data": "Likes", "title": "Likes", "class": "uk-text-right", "width": "7.5%"
            },
            {
                "title": "","width": "10%","orderable": false,"class": "sentiment uk-text-center",
                "data": "sentiment",
