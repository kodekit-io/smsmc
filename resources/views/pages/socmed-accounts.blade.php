                            ...
                            @if(count($socmed->twitter) > 0)
                                <ol id="twitter" class="uk-list-divider sm-list-item uk-margin-remove-top">
                                    @foreach($socmed->twitter as $fbAccount)
                                        <li>
                                            <input class="uk-input field-twitter" name="field_twitter[{!! $loop->iteration !!}]" type="text" placeholder="twitter" value="{!! $fbAccount->name !!}">
                                            <a onclick="delRowItem(this)" class="fa fa-close sm-del-row white-text red" title="Remove this account" uk-tooltip></a>
                                        </li>
                                    @endforeach
                                </ol>
                            ...
                            @if(count($socmed->youtube) > 0)
                                <ol id="youtube" class="uk-list-divider sm-list-item uk-margin-remove-top">
                                    @foreach($socmed->youtube as $fbAccount)
                                        <li>
                                            <input class="uk-input field-youtube" name="field_youtube[{!! $loop->iteration !!}]" type="text" placeholder="youtube" value="{!! $fbAccount->name !!}">
                                            <a onclick="delRowItem(this)" class="fa fa-close sm-del-row white-text red" title="Remove this account" uk-tooltip></a>
                                        </li>
                                    @endforeach
                                </ol>
                            ...
                            @if(count($socmed->instagram) > 0)
                                <ol id="instagram" class="uk-list-divider sm-list-item uk-margin-remove-top">
                                    @foreach($socmed->instagram as $fbAccount)
                                        <li>
                                            <input class="uk-input field-instagram" name="field_instagram[{!! $loop->iteration !!}]" type="text" placeholder="instagram" value="{!! $fbAccount->name !!}">
                                            <a onclick="delRowItem(this)" class="fa fa-close sm-del-row white-text red" title="Remove this account" uk-tooltip></a>
                                        </li>
                                    @endforeach
                                </ol>
