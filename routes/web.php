...
Route::group(['middleware' => ['auth', 'role', 'socmedAccount']], function () {
    ...
    Route::any('ontologi/{projectId}', 'ProjectController@ontologiTest');
...
//    Route::get('setting/role/{roleId}/delete', 'SettingController@roleDelete');
    ...
    Route::any('report/pdf', 'ReportController@pdf')->name('projectRead');
    Route::post('report/download-pdf', 'ReportController@downloadPdf');
